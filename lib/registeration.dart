...
//   int get a => alpha; // Alpha channel
//   int get r => red;   // Red channel
//   int get g => green; // Green channel
//   int get b => blue;  // Blue channel
// }
// extension ColorModifier on Color {
//   Color withValues(int red, int green, int blue, [int alpha = 255]) {
...
//                 colors: [const Color.fromARGB(255, 249, 90, 59),const Color.fromARGB(255, 249, 103, 19)],
